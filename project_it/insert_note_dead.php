          ...
          <div class="col-md-9">
            <div class="row">
                <div class="col-xs-9"><!--col-xs-9-->
                  <form class="form-horizontal" id="form" name="form" method="post" action="add_insert_dead.php">
                  <center><h3>บันทึกการตาย</h3></center><hr />
                  ...
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-4 control-label">วันที่บันทึก</label>
                    <div class="col-sm-4">
                      <input type="date" class="form-control" id="dead_date" name="dead_date" placeholder="">
                    </div>
                  </div>
                   <div class="form-group">
                    <label for="inputPassword3" class="col-sm-4 control-label">จำนวน</label>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" id="dead_amount" name="dead_amount" placeholder="">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-4 control-label">สาเหตุการตาย</label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="dead_cause" name="dead_cause" placeholder="">
                    </div>
                  </div>
                 ...
                 <h2>ข้อมูลบันทึกการตาย</h2>
              <p>รายละเอียดข้อมูลบันทึกการตาย สามารถเแก้ไขและลบข้อมูลได้</p></br>
                </br>
              <form class="form-horizontal" id="form1" name="form1" method="post" action="#">
                <?php
                  $strSQL = "SELECT * FROM tb_deadfish";
                  ...
                  $Num_Rows = mysql_num_rows($objQuery);
                      ...
                      $strSQL .=" order  by dead_id DESC LIMIT $Page_Start , $Per_Page";
              ...
              <table class="table">
                  ...
                  <tr align="center">
                        ...
                        <td><?php echo $row_sh['dead_date'];?></a></td>
                        <td><?php echo $row_sh['dead_amount'];?></td>
                        <td><?php echo $row_sh['dead_cause'];?></td>
                        

                        <td width="30"><a class="glyphicon glyphicon-cog" href="edit_dead.php?id=<?php echo $row_sh['dead_id'];?>"></a></td>
                        <td width="30"><a class="glyphicon glyphicon-trash" name="btnConfirm" value="Confirm"
                          onclick="return confirm('ต้องการลบหรือไม่ ?')"
                          href="delete_dead.php?id=<?php echo $row_sh['dead_id'];?>">
                        </td>
                  </tr>
                  <?php }?>
              </table>
