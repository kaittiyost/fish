    ...
    <div class="panel panel-default">
      ...
      <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="headingTwo">
          <h4 class="panel-title">
            <a class="glyphicon glyphicon-star" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
              เกร็ดความรู้
            </a>
          </h4>
        </div>
        ...
        <div id="collapseEight" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingEight">
          ...
          <div class="col-xs-12 col-md-8">
            <div class="row">
                ...
                <?php $sel_list="select * from tb_knowledge where k_id=".$_GET['id']; 
                  ...
                  <form class="form-horizontal" id="form" name="form" method="post" action="update_content.php?id=<?php echo $_GET['id']; ?>" enctype="multipart/form-data">
                  <center><h3>เพิ่มข้อมูลเกร็ดความรู้</h3></center><hr />
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">หัวข้อเรื่อง</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="k_header" name="k_header" value="<?php echo $row_list['k_header']; ?>">
                    </div>
                  </div>
                   <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">รายละเอียด</label>
                    <div class="col-sm-8">
                      <textarea class="form-control" id="k_detail"  name="k_detail" rows="5"><?php echo $row_list['k_detail']; ?></textarea>
                    </div>
                  </div>
                    <div class="form-group">
                      <label for="inputPassword3" class="col-sm-3 control-label">รูปภาพ</label>
                      <div class="col-sm-5">
                        <img src="<?php echo $row_list['k_pic']; ?>" width="150" height="150">
                        <input type="file" id="k_pic" name="k_pic">
...
<?php 
  //echo "<script>alert('Test -- alert PHP')</script>";
?>