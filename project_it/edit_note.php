    ...
    <div class="panel panel-default">
      ...
      <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="headingSix">
          <h4 class="panel-title">
            <a class="glyphicon glyphicon-calendar" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseSix" aria-expanded="true" aria-controls="collapseSix">
              บันทึกการเลี้ยงปลา
            </a>
          </h4>
        </div>
          ...
          <div class="col-md-9">
            <div class="row">
                <div class="col-xs-9"><!--col-xs-9-->
                  ...
                  <?php $sel_list="select * from tb_fish where fish_id=".$_GET['id']; 
                    $rs_list=mysqli_query($conn, $sel_list);
                    $row_list=mysqli_fetch_array($rs_list);
                  ?>

                  <form class="form-horizontal" id="form" name="form" method="post" action="update_note.php?id=<?php echo $_GET['id']; ?>">
                  <center><h3><font color="#01DF01">เพิ่มข้อมูลบันทึกการเลี้ยงปลา</font></h3></center><hr />
                   <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">หมายเลขกระชัง</label>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" id="fish_number" name="fish_number" value="<?php echo $row_list['fish_number']; ?>" readonly>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">ชื่อพันธุ์ปลา</label>
                    <div class="col-sm-5">
                      <input type="text" class="form-control" id="fish_name" name="fish_name" value="<?php echo $row_list['fish_name']; ?>">
                    </div>
                  </div>
                 
                   <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">วันที่เริ่มเลี้ยง</label>
                    <div class="col-sm-4">
                      <input type="date" class="form-control" id="fish_start" name="fish_start" value="<?php echo $row_list['fish_start']; ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">แหล่งที่มา</label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="fish_resource" name="fish_resource" value="<?php echo $row_list['fish_resource']; ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">ขนาด</label>
                    <div class="col-sm-2">
                       <input type="text" class="form-control" id="fish_size" name="fish_size" value="<?php echo $row_list['fish_size']; ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">จำนวนปลา</label>
                    <div class="col-sm-2">
                       <input type="text" class="form-control" id="fish_amount" name="fish_amount" value="<?php echo $row_list['fish_amount']; ?>">
                    </div>
                    <label>ตัว</label>
                  </div>
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">ราคาต้นทุน</label>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" id="fish_price" name="fish_price" value="<?php echo $row_list['fish_price']; ?>">
                    </div>
                    <label>บาท</label>
                  </div>
                 <hr />
