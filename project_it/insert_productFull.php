    ...
    <div class="panel panel-default">
      ...
      <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="headingThree">
          <h4 class="panel-title">
            <a class="glyphicon glyphicon-tag" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
              สินค้า
            </a>
          </h4>
        </div>
          ...
          <div class="col-xs-12 col-md-8">
            <div class="row">
                <div class="col-xs-9"><!--col-xs-9-->
                  <form class="form-horizontal" id="form" name="form" method="post" action="add_insert_productFull.php" enctype="multipart/form-data">
                  <center><h3>เพิ่มข้อมูลสินค้า</h3></center><hr />
                   <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">ประเภทสินค้า</label>
                    <div class="col-sm-8">
                      <!-- Single button -->
                    <div class="btn-group">
                      <select type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" name="category_id" id="category_id">
                       <?php $sel_list="select * from tb_category"; 
                          $rs_list=mysql_query($sel_list);
                          while($row_list=mysql_fetch_array($rs_list)){
                          ?>
                          <option value="<?php echo $row_list['category_id']?>"> <?php echo $row_list['category_name'];?>  </option>
                        <?php }?>
                      </select>
                    </div>
                    </div>
                   ...
                   <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">ชื่อสินค้า</label>
                    <div class="col-sm-5">
                      <input type="text" class="form-control" id="p_name" name="p_name" placeholder="">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">ราคา</label>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" id="p_price" name="p_price" placeholder="">
                    </div>
                    <label><b>กิโลกรัม / บาท</b></label>
                  </div>
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">จำนวน</label>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" id="p_number" name="p_number" placeholder="">
                    </div>
                    <label><b>กิโลกรัม / บาท</b></label>
                  </div>
                    <div class="form-group">
                      <label for="inputPassword3" class="col-sm-3 control-label">รูปภาพ</label>
                      <div class="col-sm-5">
                        <input type="file" id="p_pic" name="p_pic">
                        <p class="help-block">กรุณาเลือกรูปภาพที่ต้องการ.</p>
                      </div>
                    </div>
                   <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">วันที่</label>
                    <div class="col-sm-4">
                      <input type="date" class="form-control" id="p_date" name="p_date" placeholder="">
                    </div>
                  </div>
                 <hr />
                  <div class="form-group">
