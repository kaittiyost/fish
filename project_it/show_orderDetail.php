          ...
          <div class="col-md-9">
            <h2>รายละเอียดใบสั่งสินค้า</h2> 
              ...
              <table class="table"><br>       
                  ...
                  <tr align="center">
                    <tr>
                    <td width="20%"><b>รหัสใบสั่งสินค้า</b></td>
                        <td><?php echo $row_sh['order_id'];?></td>
                    </tr>
                    <tr>
                    ...
                    <td><b>ชื่อ-นามสกุล</b></td>
                        <td><?php echo $row_sh['Fullname'];?></td>
                    </tr>
                    <tr>
                    <td><b>ที่อยู่</b></td>
                    ...
                    <tr>
                    <td><b>ราคารวม</b></td>
                        <td><?php echo $row_sh['order_total']." บาท";?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                    <td><b>เลขบัญชี</b></td>
                        <td><?php echo $row_sh['card'];?></td>
                    </tr>   
                    <tr>
                    <td><b>สถานะ การชำระเงิน</b></td>
