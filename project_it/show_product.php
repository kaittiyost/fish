    ...
    <div class="panel panel-default">
      ...
      <div class="panel panel-default">
        ...
        <div id="collapseEight" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingEight">
          ...
          <div class="col-md-9">
            <h2>ข้อมูลสินค้า</h2>
              <p>รายละเอียดข้อมูลสินค้า สามารถเแก้ไขและลบข้อมูลได้</p></br>
              </br>
              ...
              <table class="table" >
                  ...
                  <tr align="center">
                        ...
                        <td align="left"><?php echo $row_sh['p_name'];?></td>                        
                        <td><img src="<?php echo $row_sh['p_pic'];?>" width="100" height="100"></td>
                        <td><?php echo $row_sh['p_price'];?></td>
                        <td><?php echo $row_sh['p_number'];?></td>
                        <td><?php echo $row_sh['p_date'];?></td>
                        <td width="30"><a class="glyphicon glyphicon-cog" href="edit_productFull.php?id=<?php echo $row_sh['p_id'];?>"></a></td>
                        <td width="30"><a class="glyphicon glyphicon-trash" name="btnConfirm" value="Confirm"
                          onclick="return confirm('ต้องการลบหรือไม่ ?')"
                          href="delete_product.php?id=<?php echo $row_sh['p_id'];?>">
                        </td>
                  </tr>
                  <?php }?>
              </table>
