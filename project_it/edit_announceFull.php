          ...
          <div class="col-md-9">
             <div class="row">
                <div class="col-xs-9"><!--col-xs-9-->
                  <form class="form-horizontal" id="form" name="form" method="post" action="update_announceFull.php?id=<?php echo $_GET['id']; ?>" enctype="multipart/form-data">
                  ...
                  ?>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="post_header" name="post_header" placeholder="" value="<?php echo $row_list['post_header']; ?>">
                    </div>
                  </div>
                   <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">รายละเอียด</label>
                    <div class="col-md-8">
                      <textarea class="form-control" id="post_detail"  name="post_detail" rows="5"><?php echo $row_list['post_detail']; ?></textarea>
                    </div>
                  </div>
                    <div class="form-group">
                      <label for="inputPassword3" class="col-sm-3 control-label">รูปภาพ</label>
                      <div class="col-sm-5">
                      <img src="<?php echo $row_list['post_pic']; ?>" width="150" height="150">
