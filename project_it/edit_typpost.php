          ...
          <div class="col-md-9">
            <div class="row">
                <div class="col-xs-9"><!--col-xs-9-->
                  <form class="form-horizontal" id="form" name="form" method="post" action="update_announce.php?id=<?php echo $_GET['id']; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      <input type="text" class="form-control" id="tp_title" name="tp_title" value="<?php echo $row_edit['tp_title'];?>">
                    </div>
                  </div>
                 <hr />
                  <div class="form-group">
