          ...
          <div class="col-md-9">
            <div class="row">
                <div class="col-xs-9"><!--col-xs-9-->
                  <form class="form-horizontal" id="form" name="form" method="post" action="update_feed.php?id=<?php echo $_GET['id']; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      <input type="text" class="form-control" id="feed_name" name="feed_name" value="<?php echo $row_list['feed_name']; ?>">
                    </div>
                  </div>
                   <div class="form-group">
                    <label for="inputPassword3" class="col-sm-4 control-label">วันที่ลงอาหาร</label>
                    <div class="col-sm-4">
                      <input type="date" class="form-control" id="feed_date" name="feed_date" value="<?php echo $row_list['feed_date']; ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-4 control-label">จำนวนอาหาร</label>
                    <div class="col-sm-2">
                      <input type="text" class="form-control" id="feed_amount" name="feed_amount" value="<?php echo $row_list['feed_amount']; ?>">
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-2">
                       <input type="text" class="form-control" id="feed_total" name="feed_total" value="<?php echo $row_list['feed_total']; ?>">
                    </div>
                    <label>กิโลกรัม</label>
                  </div>
