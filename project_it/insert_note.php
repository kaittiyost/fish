          ...
          <div class="col-md-9">
            <div class="row">
                <div class="col-xs-9"><!--col-xs-9-->
                  <form class="form-horizontal" id="form" name="form" method="post" action="add_insert_note.php">
                  <center><h3><font color="#01DF01">เพิ่มข้อมูลบันทึกการเลี้ยงปลา</font></h3></center><hr />
                   <div class="form-group">
                    ...
                    <div class="col-sm-3">
                      <input type="text" class="form-control" id="fish_number" name="fish_number" placeholder="FISH000">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">ชื่อพันธุ์ปลา</label>
                    <div class="col-sm-5">
                      <input type="text" class="form-control" id="fish_name" name="fish_name" placeholder="">
                    </div>
                  </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="date" class="form-control" id="fish_start" name="fish_start" placeholder="">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">แหล่งที่มา</label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="fish_resource" name="fish_resource" placeholder="">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">ขนาด</label>
                    <div class="col-sm-2">
                       <input type="text" class="form-control" id="fish_size" name="fish_size" placeholder="">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">จำนวนปลา</label>
                    <div class="col-sm-2">
                       <input type="text" class="form-control" id="fish_amount" name="fish_amount">
                    </div>
                    <label>ตัว</label>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                      <input type="text" class="form-control" id="fish_price" name="fish_price" placeholder="">
                    </div>
                    <label>บาท</label>
                  </div>
                 <hr />
