          ...
          <div class="col-md-9">
            <div class="row">
                <div class="col-xs-9"><!--col-xs-9-->
                  <form class="form-horizontal" id="form" name="form" method="post" action="add_insert_growth.php">
                  <center><h3>บันทึกการเจริญเติบโต</h3></center><hr />
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="date" class="form-control" id="growth_date" name="growth_date" placeholder="">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-4 control-label">ขนาดของปลาที่เพิ่มขึ้น</label>
                    <div class="col-sm-2">
                      <input type="text" class="form-control" id="growth_size" name="growth_size" placeholder="size">
                    </div>
                  </div>
                 ...
                 <h2>ข้อมูลการเจริญเติบโต</h2>
              <p>รายละเอียดข้อมูลการเจริญเติบโต สามารถเแก้ไขและลบข้อมูลได้</p></br>
                </br>
              ...
              <table class="table">
                  <tr  align="center" class="success"> 
                        ...
                        <td><b>ขนาดของปลาที่เพิ่ม (size)</b></td>
                        <td><b>แก้ไข</b></td>
                        <td><b>ลบ</b></td>
                  </tr>
                    <?php
                  ...
                  <tr align="center">
                        ...
                        <td><?php echo $row_sh['growth_date'];?></td>
                        <td><?php echo $row_sh['growth_size'];?></td>
                        <td width="30"><a class="glyphicon glyphicon-cog" href="edit_growth.php?id=<?php echo $row_sh['growth_id'];?>"></a></td>
                        <td width="30"><a class="glyphicon glyphicon-trash" name="btnConfirm" value="Confirm"
                          onclick="return confirm('ต้องการลบหรือไม่ ?')"
                          href="delete_growth.php?id=<?php echo $row_sh['growth_id'];?>">
                        </td>
                  </tr>
                  <?php }?>
              </table>
