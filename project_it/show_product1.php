   ...
   <div class="row">
    ...
    <div class="row"><!--content-->
      ...
      <ul class="nav nav-tabs" style="border-color: red;">
          <li role="presentation"><a href="show_product_list.php"><b>รวมทั้งหมด</b></a></li>
          <li role="presentation" class="active"><a href="show_product1.php"><b>ปลาเลี้ยง(ลูกปลา)</b></a></li>
          <li role="presentation"><a href="show_product2.php"><b>ปลาเลี้ยง(ปลาโต)</b></a></li>
        </ul>
          <br>
        <?php 
          $sql = mysqli_query($conn, "select * from tb_product where category_id=1"); 
        ?>    
        <div class="row">         
