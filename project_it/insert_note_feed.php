          ...
          <div class="col-md-9">
            <div class="row">
                <div class="col-xs-9"><!--col-xs-9-->
                  <form class="form-horizontal" id="form" name="form" method="post" action="add_insert_feed.php">
                  <center><h3>บันทึกการให้อาหาร</h3></center><hr />
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-4 control-label">มหายเลขกระชัง</label>
                    <div class="col-sm-8">
                      <!-- Single button -->
                    <div class="btn-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      <input type="text" class="form-control" id="feed_name" name="feed_name" placeholder="">
                    </div>
                  </div>
                   <div class="form-group">
                    <label for="inputPassword3" class="col-sm-4 control-label">วันที่ลงอาหาร</label>
                    <div class="col-sm-4">
                      <input type="date" class="form-control" id="feed_date" name="feed_date" placeholder="">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-4 control-label">จำนวนอาหาร</label>
                    <div class="col-sm-2">
                      <input type="text" class="form-control" id="feed_amount" name="feed_amount" placeholder="">
                    </div>
                    <label>กิโลกรัม</label>
                  </div>
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-4 control-label">จำนวนอาหารทั้งหมด</label>
                    <div class="col-sm-2">
                       <input type="text" class="form-control" id="feed_total" name="feed_total" placeholder="">
                    </div>
                    <label>กิโลกรัม</label>
                  </div>
                 ...
                 <h2>ข้อมูลการให้อาหาร</h2>
              <p>รายละเอียดข้อมูลการให้อาหารสามารถเแก้ไขและลบข้อมูลได้</p></br>
                </br>
              ...
              <table class="table">
                  <tr  align="center" class="success"> 
                        ...
                        <td><b>ชื่ออาหารปลา</b></td>                        
                        <td><b>วันที่ลงอาหาร</b></td>
                        <td><b>จำนวนอาหาร(กิโลกรัม)</b></td>
                        <td><b>จำนวนอาหารทั้งหมด(กิโลกรัม)</b></td>
                        <td><b>แก้ไข</b></td>
                        <td><b>ลบ</b></td>
                  </tr>
                    <?php
                  ...
                  <tr align="center">
                        ...
                        <td><?php echo $row_sh['feed_name'];?></a></td>
                        <td><?php echo $row_sh['feed_date'];?></td>
                        <td><?php echo $row_sh['feed_amount'];?></td>
                        <td><?php echo $row_sh['feed_total'];?></td>
                        <td width="30"><a class="glyphicon glyphicon-cog" href="edit_feed.php?id=<?php echo $row_sh['feed_id'];?>"></a></td>
                        <td width="30"><a class="glyphicon glyphicon-trash" name="btnConfirm" value="Confirm"
                          onclick="return confirm('ต้องการลบหรือไม่ ?')"
                          href="delete_feed.php?id=<?php echo $row_sh['feed_id'];?>">
                        </td>
                  </tr>
                  <?php }?>
              </table>
