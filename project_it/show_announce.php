     ...
     <div class="panel panel-default">
      ...
      <div class="panel panel-default">
        ...
        <div id="collapseEight" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingEight">
          ...
          <div class="col-md-9">
            <h2>ข้อมูลข่าวสาร</h2>
              <p>รายละเอียดข้อมูลข่าวสารต่างๆ สามารถเแก้ไขและลบข้อมูลได้</p></br>
              </br>
              <form class="form-horizontal" id="form1" name="form1" method="post" action="#" enctype="multipart/form-data">
              <?php
                  $strSQL = "SELECT * FROM tb_postmessage t_post,tb_type_post t_type WHERE t_post.tp_id=t_type.tp_id";
              ...
              <table class="table" >
                  ...
                  <tr align="center">
                        ...
                        <td align="left"><?php echo $row_sh['post_header'];?></td>
                        <td align="left"><?php echo $row_sh['post_detail'];?></td>
                        <td><img src="<?php echo $row_sh['post_pic'];?>" width="100" height="100"></td>
                        <td><?php echo $row_sh['post_date'];?></td>
                        <td width="30"><a class="glyphicon glyphicon-cog" href="edit_announceFull.php?id=<?php echo $row_sh['post_id'];?>"></a></td>
                        <td width="30"><a class="glyphicon glyphicon-trash" name="btnConfirm" value="Confirm" 
                          onclick="return confirm('ต้องการลบหรือไม่ ?')" 
                          href="delete_announce.php?id=<?php echo $row_sh['post_id'];?>">
                        </td>
                  </tr>
                  <?php }?>
              </table>
