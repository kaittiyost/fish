      ...
      <div class="panel panel-default">
        ...
        <div id="collapseEight" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingEight">
          ...
          <h2>ข้อมูลบันทึกการเลี้ยงปลา</h2>
              <p>รายละเอียดข้อมูลบันทึกการเลี้ยงปลา สามารถเแก้ไขและลบข้อมูลได้</p></br>
               </br>
              ...
              <table class="table">
                  ...
                  <tr align="center">
                        ...
                        <td width="30"><a class="glyphicon glyphicon-cog" href="edit_note.php?id=<?php echo $row_sh['fish_id'];?>"></a></td>
                        <td width="30"><a class="glyphicon glyphicon-trash" name="btnConfirm" value="Confirm"
                          onclick="return confirm('ต้องการลบหรือไม่ ?')"
                          href="delete_fish.php?id=<?php echo $row_sh['fish_id'];?>">
                        </td>
                  </tr>
                  <?php }?>
              </table>
