        ...
        <div id="collapseEight" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingEight">
          ...
          <div class="col-md-9">
           <?php 
                  ...
                  $sel_list="select * from tb_bank where bank_id=".$_GET['id']; 
                    $rs_list=mysqli_query($conn, $sel_list);
                    $row_list=mysqli_fetch_array($rs_list);

                 ?>
             <h2>แก้ไขข้อมูลแจ้งชำระสินค้า</h2>
              <p>รายละเอียดข้อมูลแจ้งชำระสินค้าทั้งหมด สามารถเแก้ไขและลบข้อมูลได้</p></br>
              </br>
              <div class="row">
                <div class="col-md-6">
                  <form class="form-horizontal" id="form" name="form" method="post" action="update_bank.php?id=<?php echo $_GET['id']; ?>">
                  <center><h3>เพิ่มข้อมูลบัญชีธนาคาร</h3></center><hr />
                 
                   <div class="form-group">
                    <label for="inputPassword3" class="col-sm-4 control-label">เลขบัญชีธนาคาร</label>
                    <div class="col-sm-5">
                      <input type="text" class="form-control" id="bank_number" name="bank_number" value="<?php echo $row_list['bank_number'];?>">
                    </div>
                  </div>
                   <div class="form-group">
                    <label for="inputPassword3" class="col-sm-4 control-label">ชื่อบัญชีธนาคาร</label>
                    <div class="col-sm-5">
                      <input type="text" class="form-control" id="bank_name" name="bank_name" value="<?php echo $row_list['bank_name'];;?>">
                    </div>
                  </div>
                  <div class="form-group">
