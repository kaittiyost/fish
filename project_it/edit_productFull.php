          ...
          <div class="col-xs-12 col-md-8">
            <div class="row">
                <div class="col-xs-9"><!--col-xs-9-->
                  <form class="form-horizontal" id="form" name="form" method="post" action="update_productFull.php?id=<?php echo $_GET['id']; ?>" enctype="multipart/form-data">
                  <center><h3>แก้ไขข้อมูลสินค้า</h3></center><hr />
                  

                  <?php 
                    $sel_list="select * from tb_product where p_id=".$_GET['id']; 
                  ...
                  ?>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      <input type="text" class="form-control" id="p_name" name="p_name" value="<?php echo $row_list['p_name']; ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">ราคา</label>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" id="p_price" name="p_price" value="<?php echo $row_list['p_price']; ?>">
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                      <input type="text" class="form-control" id="p_number" name="p_number" value="<?php echo $row_list['p_number']; ?>">
                    </div>
                    <label><b>กิโลกรัม / บาท</b></label>
                  </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-5">
                      <img src="<?php echo $row_list['p_pic']; ?>" width="150" height="150">
