          ...
          <div class="col-md-9">
            <div class="row">
                <div class="col-xs-9"><!--col-xs-9-->
                  <form class="form-horizontal" id="form" name="form" method="post" action="add_insert_announce.php">
                  <center><h3>เพิ่มข้อมูลประเภทข่าวสาร</h3></center><hr />
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">หัวข้อข่าวสาร</label>
                    <div class="col-sm-5">
                      <input type="text" class="form-control" id="tp_title" name="tp_title" placeholder="News">
                    </div>
                  </div>
                 <hr />
                  <div class="form-group">
                  ...
                  <!--SELECT-->
                <h2>ข้อมูลประเภทข่าวสาร</h2>
              <p>รายละเอียดข้อมูลรายละเอียดประเภทข่าวสาร สามารถเแก้ไขและลบข้อมูลได้</p></br>
                </br>
              ...
              <table class="table">
                  ...
                  <tr align="center">
                        ...
                        <td width="30"><a class="glyphicon glyphicon-cog" href="edit_typpost.php?id=<?php echo $row_sh['tp_id'];?>"></a></td>
                        <td width="30"><a class="glyphicon glyphicon-trash" name="btnConfirm" value="Confirm"
                          onclick="return confirm('ต้องการลบหรือไม่ ?')"
                          href="delete_typpost.php?id=<?php echo $row_sh['tp_id'];?>">
                        </td>
                  </tr>
                  <?php }?>
              </table>
