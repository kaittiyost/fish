          ...
          <div class="col-xs-12 col-md-8">
            <div class="row">
                <div class="col-xs-9"><!--col-xs-9-->
                  <form class="form-horizontal" id="form" name="form" method="post" action="add_insert_content.php" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="k_header" name="k_header" placeholder="">
                    </div>
                  </div>
                   <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">รายละเอียด</label>
                    <div class="col-sm-5">
                      <textarea class="form-control" id="k_detail"  name="k_detail"></textarea>
                    </div>
                  </div>
                    <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      <input type="date" class="form-control" id="k_date" name="k_date" placeholder="">
                    </div>
                  </div>
                 <hr />
                  <div class="form-group">
