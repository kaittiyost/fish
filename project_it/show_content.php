    ...
    <div class="panel panel-default">
      ...
      <div class="panel panel-default">
        ...
        <div id="collapseEight" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingEight">
          ...
          <div class="col-md-9">
            <h2>ข้อมูลเกร็ดความรู้</h2>
              <p>รายละเอียดข้อมูลเกร็ดความรู้ต่างๆ สามารถเแก้ไขและลบข้อมูลได้</p></br>
              </br>
              ...
              <table class="table" width="900">
                  ...
                  <tr align="center">
                        ...
                        <td align="left"><?php echo $row_sh['k_detail'];?></td>
                        <td><img src="<?php echo $row_sh['k_pic'];?>" width="100" height="100"></td>
                        <td><?php echo $row_sh['k_date'];?></td>
                        <td width="30"><a class="glyphicon glyphicon-cog" href="edit_content.php?id=<?php echo $row_sh['k_id'];?>"></a></td>
                        <td width="30"><a class="glyphicon glyphicon-trash" name="btnConfirm" value="Confirm"
                          onclick="return confirm('ต้องการลบหรือไม่ ?')"
                          href="delete_content.php?id=<?php echo $row_sh['k_id'];?>">
                        </td>
                  </tr>
                  <?php }?>
              </table>
