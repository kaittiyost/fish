          ...
          <div class="col-md-9">
            <div class="row">
                <div class="col-xs-9"><!--col-xs-9-->
                  <form class="form-horizontal" id="form" name="form" method="post" action="update_dead.php?id=<?php echo $_GET['id']; ?>">
                  <center><h3>บันทึกการตาย</h3></center><hr />
                   
                   <?php 
                    @$sel_list="select * from tb_deadfish where dead_id=".$_GET['id']; 
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="date" class="form-control" id="dead_date" name="dead_date" value="<?php echo $row_list['dead_date']; ?>">
                    </div>
                  </div>
                   <div class="form-group">
                    <label for="inputPassword3" class="col-sm-4 control-label">จำนวน</label>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" id="dead_amount" name="dead_amount" value="<?php echo $row_list['dead_amount']; ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-4 control-label">สาเหตุการตาย</label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="dead_cause" name="dead_cause" value="<?php echo $row_list['dead_cause']; ?>">
                    </div>
                  </div>
