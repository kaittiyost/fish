  ...
  <div class="container-fluid">
    ...
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand  glyphicon glyphicon-flag" href="index.php"><b> KINGDOM <font color="#01DF01">FISH</font>
            </b></a>
      </div>
...
if (isset($_SESSION['user_id']) && !empty($_SESSION['user_id'])) { ?>
        <ul class="nav navbar-nav navbar-right">
          <li><a href="user_edit.php?id=<?php echo $_SESSION['user_id']; ?>">
              <font color="#01DF01"><b>ยินดีต้อนรับ</b></font> :
        ...
        <ul class="nav navbar-nav navbar-right">
          <li><a href="register.php"><span class="glyphicon glyphicon-user"></span> <b> SIGN <font color="#01DF01">UP
                </font></b></a></li>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="show_list4.php" class="glyphicon glyphicon-triangle-right">
                    โรคที่เกิดจากปลาและวิธีการรักษา</a></li>
                <li><a href="show_list5.php" class="glyphicon glyphicon-triangle-right"> พื้นที่การเลี้ยงที่เหมาะสม</a>
                </li>
                <li><a href="show_list6.php" class="glyphicon glyphicon-triangle-right"> ประเภทปลาที่เหมาะสม</a></li>
                <li><a href="show_list7.php" class="glyphicon glyphicon-triangle-right"> อาหารและวิธีการให้อาหาร</a>
                </li>
                <li><a href="show_list8.php" class="glyphicon glyphicon-triangle-right"> อุปกรณ์ในการสร้างกระชัง</a>
                </li>
              </ul>
            </li>
