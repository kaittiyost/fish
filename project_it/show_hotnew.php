   ...
   <?php include 'header.php';?>
    <div class="row"><!--row1-->
      <div class="container" align="center"> 
        ...
        <div class="col-md-12">
          <div class="container" align="center">
            <h1><img src="./img/postnew.png" width="350" height="70"></h1>
          </div>
          </div>
        </div><br>

        <ul class="nav nav-tabs" style="border-color: #3399FF;">
          <li role="presentation" class="active"><a href="show_hotnew.php"><b>รวมทั้งหมด</b></a></li>
          <li role="presentation"><a href="show_new1.php"><b>ประกาศ</b></a></li>
      ...
      <div class="container" align="center"> 
        <?php $sql = mysqli_query($conn, "select * from tb_postmessage"); ?>    
        <div class="row">         
