     ...
     <div class="panel panel-default">
      ...
      <div class="panel panel-default">
        ...
        <div id="collapseEight" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingEight">
          ...
          <div class="col-md-9">
            <h2>ข้อมูลสมาชิก</h2>
              <b>รายละเอียดข้อมูลสมาชิกต่างๆ สามารถเแก้ไขและลบข้อมูลได้</b>
              ...
              <?php
                  $strSQL = "SELECT * FROM tb_user WHERE status=2";
                  ...
                  $Num_Rows = mysqli_num_rows($objQuery);
                      ...
                      $strSQL .=" order  by user_id DESC LIMIT $Page_Start , $Per_Page";
              ...
              <table class="table">
                  <tr  align="center" class="success"> 
                    ...
                    ?>
                  <tr align="center">
                        <td><?php echo $row_sh['user_name'];?></a></td>
                        <td><?php echo $row_sh['pass_word'];?></td>
                        <td><?php echo $row_sh['fname'];?></td>
                        <td><?php echo $row_sh['lname'];?></td>
                        <td><?php echo $row_sh['address'];?></td>
                        <td><?php echo $row_sh['phone'];?></td>
                        <td><?php echo $row_sh['status'];?></td>
                        <td width="30"><a class="glyphicon glyphicon-cog" href="edit_user.php?id=<?php echo $row_sh['user_id'];?>"></a></td>
                        <td width="30"><a class="glyphicon glyphicon-trash"  name="btnConfirm" value="Confirm"
                           onclick="return confirm('ต้องการลบหรือไม่ ?')"
                           href="delete_user.php?id=<?php echo $row_sh['user_id'];?>">
                        </td>
                  </tr>
                  <?php }?>
              </table>
