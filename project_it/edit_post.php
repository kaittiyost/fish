                ...
                <div class="col-xs-9"><!--col-xs-9-->
                 <?php 
                  ...
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">หัวข้อคำถาม</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="Question" name="Question" value="<?php echo $row_list['Question']; ?>">
                    </div>
                  </div>
                   <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">รายละเอียด</label>
                    <div class="col-sm-8">
                      <textarea class="form-control" id="Details"  name="Details"><?php echo $row_list['Details']; ?></textarea>
                    </div>
                  </div>
