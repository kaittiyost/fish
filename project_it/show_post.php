    ...
    <div class="panel panel-default">
      ...
      <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="headingSeven">
          <h4 class="panel-title">
            <a class="glyphicon glyphicon-transfer" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseSeven" aria-expanded="true" aria-controls="collapseSeven">
              เว็บบอร์ดคำถาม
            </a>
          </h4>
        </div>
      ...
      <div class="panel panel-default">
        ...
        <div id="collapseEight" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingEight">
          ...
          <div class="col-md-9">
             <h2>ข้อมูลคำถาม</h2>
              <b>รายละเอียดข้อมูลคำถาม สามารถเแก้ไขและลบข้อมูลได้</b>
              ...
              <table class="table"><br>
                  ...
                  <tr align="center">
                        ...
                        <td><?php echo $row_sh['Question'];?></td>
                        <td><?php echo $row_sh['Name'];?></td>
                        <td><?php echo $row_sh['View'];?></td>
                        <td><?php echo $row_sh['Reply'];?></td>
                        <td width="30"><a class="glyphicon glyphicon-cog" href="edit_post.php?id=<?php echo $row_sh['QuestionID'];?>"></a></td>
                        <td width="30"><a class="glyphicon glyphicon-trash"  name="btnConfirm" value="Confirm" 
                          onclick="return confirm('ต้องการลบหรือไม่ ?')" 
                          href="delete_post.php?id=<?php echo $row_sh['QuestionID'];?>">
                        </td>
                  </tr>
                  <?php }?>
              </table>
