        ...
        <div id="collapseEight" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingEight">
          ...
          <div class="row">
                <div class="col-xs-9"><!--col-xs-9-->
                  <form class="form-horizontal" id="form" name="form" method="post" action="add_category.php">
                  <center><h3>เพิ่มข้อมูลประเภทสินค้า</h3></center><hr />
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">ประเภทสินค้า</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="category_name" name="category_name" placeholder="เพิ่มประเภทสินค้า">
                    </div>
                  </div>
              ...
              <p>รายละเอียดข้อมูลรายละเอียดประเภทสินค้าสามารถเแก้ไขและลบข้อมูลได้</p></br>
                </br>
              <form class="form-horizontal" id="form1" name="form1" method="post" action="#">
                <?php
                  ...
                  $Num_Rows = mysqli_num_rows($objQuery);
                      ...
                      $strSQL .=" order  by category_id DESC LIMIT $Page_Start , $Per_Page";
              ...
              <table class="table">
                  ...
                  <tr align="center">
                        ...
                        <td width="30"><a class="glyphicon glyphicon-cog" href="edit_type_product.php?id=<?php echo $row_sh['category_id'];?>"></a></td>
                        <td width="30"><a class="glyphicon glyphicon-trash" name="btnConfirm" value="Confirm"
                          onclick="return confirm('ต้องการลบหรือไม่ ?')"
                          href="delete_category.php?id=<?php echo $row_sh['category_id'];?>">
                        </td>
                  </tr>
                  <?php }?>
              </table>
