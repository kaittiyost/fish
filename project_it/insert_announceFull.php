          ...
          <div class="col-xs-12 col-md-8">
             <div class="row">
                <div class="col-xs-9"><!--col-xs-9-->
                  <form class="form-horizontal" id="form" name="form" method="post" action="add_insert_announceFull.php" enctype="multipart/form-data">
                  <center><h3>อัพเดทข่าวสาร</h3></center><hr />
                    <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">ประเภทข่าว</label>
                    <div class="col-sm-8">
                      <!-- Single button -->
                    <div class="btn-group">
                   ...
                   <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">หัวข้อข่าว</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="post_header" name="post_header" placeholder="">
                    </div>
                  </div>
                   <div class="form-group">
                    <label for="inputPassword3" class="col-sm-3 control-label">รายละเอียด</label>
                    <div class="col-sm-5">
                      <textarea class="form-control" id="post_detail"  name="post_detail"></textarea>
                    </div>
                  </div>
                    <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      <input type="date" class="form-control" id="post_date" name="post_date" placeholder="">
                    </div>
                  </div>
                 <hr />
                  <div class="form-group">
