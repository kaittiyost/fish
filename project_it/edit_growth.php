          ...
          <div class="col-md-9">
            <div class="row">
                <div class="col-xs-9"><!--col-xs-9-->
                  <form class="form-horizontal" id="form" name="form" method="post" action="update_growth.php?id=<?php echo $_GET['id']; ?>">
                  <center><h3>บันทึกการเจริญเติบโต</h3></center><hr />
                
                   <?php $sel_list="select * from tb_growth where growth_id=".$_GET['id']; 
                  ...
                  ?>
                   <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="date" class="form-control" id="growth_date" name="growth_date" value="<?php echo $row_list['growth_date']; ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-4 control-label">ขนาดของปลาที่เพิ่มขึ้น</label>
                    <div class="col-sm-2">
                      <input type="text" class="form-control" id="growth_size" name="growth_size" value="<?php echo $row_list['growth_size']; ?>">
                    </div>
                  </div>
